...
// Create a personal copy named `config.js`
// Inside your 'config.js' file, rename 'window.DASHBOARD_DEFAULT_CONFIG' to 'window.DASHBOARD_CONFIG'
// Then edit the config to your liking and it won't be overwritten when you pull the latest changes.
